...
/**
 * is_printable - The program evaluates if a char is printable
 * @c: Char will be evaluated.
 *
...
/**
 * append_hexa_code - Program append ascci in hexadecimal code to buffer
...
/**
 * is_digit - will verifies if a char is a digit
 * @c: Char will be evaluated
 *
